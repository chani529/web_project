...
<div class="container" id="cq_list_container">
	<h3>고객 센터</h3>
	<div class="row">
		<table class="table">
			<colgroup>
			...
			<tbody>
			 ...
			 <td>${item.btype}</td>
			 <td class="text-left"><a href="${pageContext.request.contextPath}/BDetail.do?bno=${item.bno}">${item.btitle}</a></td>
			 <td>${item.bname}</td>
			 <td>${item.bdate}</td>
			 <td>${item.bhit}</td>
			 </tr>
...
<a href="<%=request.getContextPath()%>/BWrite_view.do"
