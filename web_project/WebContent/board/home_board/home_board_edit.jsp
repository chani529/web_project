...
<div class="row">
	...
	<form action="<%=request.getContextPath()%>/HBEdit.hb?bno=${dto.bno}" method="post"
		id="write_submit" enctype="multipart/form-data">
		<div class="row">
		<input type="hidden" value="${dto.bfile}" name="hidden_bfile"/>
		<div class="panel hb_accodian">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<input type="number" id="realArea" name="realArea"
								class="form-control" value="${dto.realArea}"/>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<input type="text" id="family" name="family"
								class="form-control" value="${dto.family}"/>
						</div>
					</div>
					<div class="row">
		...
		<div class="form-group">
			...
			placeholder="내용을 입력해주세요.">${dto.bcontent}</textarea>
			</div>	
