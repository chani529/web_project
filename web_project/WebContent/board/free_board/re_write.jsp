...
<div class="container">
	<h3>자유게시판-답글 </h3>
		<form action="${pageContext.request.contextPath}/reply.reply" method="post"  id="writeForm" >
		   <fieldset>
		   ...
		   <input type="hidden" value="${dto.bindent}" name = "bindent"/>
			...
			<div class="form-group">
			  ...
			  <input type="text"   name="btitle"   id="btitle"   class="form-control" value="ㄴre:${dto.btitle}"> 
			</div>	
			<div class="form-group">
